...
class UserRegisterEmailScreen extends StatefulWidget {
  static const routeName = '/UserRegisterEmailScreen';

  @override
  _UserRegisterEmailScreenState createState() =>
      _UserRegisterEmailScreenState();
}

class _UserRegisterEmailScreenState extends State<UserRegisterEmailScreen> {
  ...
  Future<String> submit() async {
    ...
    Provider.of<UserInfo>(context, listen: false).userInSend.rePassword =
