...
class UserRegisterVerificationCodeScreen extends StatefulWidget {
  static const routeName = '/UserRegisterVerificationCodeScreen';

  @override
  _UserRegisterVerificationCodeScreenState createState() =>
      _UserRegisterVerificationCodeScreenState();
}

class _UserRegisterVerificationCodeScreenState
    extends State<UserRegisterVerificationCodeScreen> {
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.of(context).pushNamed(
                                    UserRegisterEmailScreen.routeName);
                              },
                              child: Container(
                                height: 48,
                                decoration: BoxDecoration(
