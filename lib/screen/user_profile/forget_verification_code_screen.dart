...
class ForgetVerificationCodeScreen extends StatefulWidget {
  static const routeName = '/ForgetVerificationCodeScreen';

  @override
  _ForgetVerificationCodeScreenState createState() => _ForgetVerificationCodeScreenState();
}

class _ForgetVerificationCodeScreenState extends State<ForgetVerificationCodeScreen> {
  ...
  void didChangeDependencies() async {
    if (_isInit) {
      username = Provider.of<UserInfo>(context, listen: false).userInSend.userName;
      setState(() {});
      _isInit = false;
    }
  ...
  Future<String> sendCode() async {
    String response = await Provider.of<Auth>(context, listen: false).authenticate(
      codeController.text,
    );
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Image.asset(
                            'assets/images/signup_header_ic.png',
                            height: 90,
                            width: 90,
                          ),
                          Padding(
                          ...
                          Padding(
                            ...
                            child: Text(
                              'verification code sends your email. please enter blow field to continue to sign up process',
                              overflow: TextOverflow.ellipsis,
                              textAlign: TextAlign.center,
                              maxLines: 3,
                              style: TextStyle(
                          ...
                          Padding(
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.of(context).pushNamed(UserRegisterEmailScreen.routeName);
                              },
                              child: Container(
                                height: 48,
