...
//<editor-fold desc="Data Methods" defaultstate="collapsed">
  ...
  factory SelfMadeFoodCart.fromMap(Map<String, dynamic> map) {
    return new SelfMadeFoodCart(
      FoodId: map['FoodId'],
